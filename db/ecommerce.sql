...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jul 2024 pada 09.24
...
CREATE TABLE `tb_komentar` (
  `id` int(11) NOT NULL,
  `nama` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `website` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
